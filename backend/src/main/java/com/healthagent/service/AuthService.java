...
import com.healthagent.config.JwtSecretProvider;
...
public class AuthService {
     ...
     */
    @Value("${healthagent.default-password:}")
    ...
    @Value("${healthagent.auth.access-token-expiration-minutes:120}")
    private long accessTokenExpirationMinutes;

    @Value("${healthagent.auth.refresh-token-expiration-hours:168}")
