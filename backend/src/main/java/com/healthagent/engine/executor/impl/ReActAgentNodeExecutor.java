...
import com.healthagent.engine.agent.AgentTool;
import com.healthagent.engine.agent.AgentToolContext;
import com.healthagent.engine.agent.AgentToolRegistry;
...
public class ReActAgentNodeExecutor extends AbstractLLMNodeExecutor {
    ...
    private String buildSystemPrompt(LLMNodeConfig config, List<AgentTool> tools) {
        ...
        sb.append("你是一个运行在 healthagent 工作流节点里的 ReAct Agent。\n");
