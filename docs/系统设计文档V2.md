...
#### 4.2.2 examination_hospital（医院信息表）
...
#### 4.2.3 examination_package（体检套餐表）
...
#### 4.2.4 examination_booking（体检预约表）
...
1. **MyBatis-Plus DB 模式**：通过 PolInfoMapper 查询 examination_hospital 数据库
